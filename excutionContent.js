...
var s = 20;
console.log(s); // Logs 20 because var s was initialized above

let num = 20; // Declared and initialized before access to avoid Temporal Dead Zone ReferenceError
console.log(num); // Logs 20

sayHello(); // Function declarations are hoisted completely, so this calls sayHello successfully
function sayHello() {
    console.log("Hello!");
}
